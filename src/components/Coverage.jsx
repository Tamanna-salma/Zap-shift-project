...
const Coverage = () => {
  ...
  return (
    <div>
        <h2 className='text-center text-4xl mt-8 font-bold'>We are avaliable in 64 Districts</h2>
    ...
    <form onSubmit={handleSearch}>
                ...
                <input type="button" value="Click me" className="btn bg-[#CAEB66]" />

        </div>
        
        {/* * */}
        <div className='border h-[600px] mx-auto max-w-7xl mt-3 '>
 <MapContainer 
 center={position}
  zoom={8}
